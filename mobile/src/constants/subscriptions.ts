 ...
 *
 * Note: These are hardcoded for production builds since process.env is not
 * available in TestFlight/production builds. These are public client-side IDs
 * so hardcoding them is safe.
 */

// Stripe Price IDs (from STRIPE_PRICE_IDS.md)
